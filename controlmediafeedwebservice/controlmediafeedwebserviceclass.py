##
#        File: controlmediafeedwebserviceclass.py
#     Created: 11/18/2020
#     Updated: 11/18/2020
#  Programmer: Cuates
#  Updated By: Cuates
#     Purpose: Control media feed web service class
#     Version: 0.0.1 Python3
##

# Import modules
import controlmediafeedwebserviceconfig # control media feed web service configuration
...
# Class
class ControlMediaFeedWebServiceClass():
  # Constructor
  def __init__(self):
    pass

  # Extract control media feed
  def _extractControlMediaFeed(self, type, actionWord, selectColumn, procedure, optionMode, possibleParams, feedStorage):
                ...
                if buildQueryEntry.get('SError') == None:
                  ...
                  # PostgreSQL query statement
                    ...
                    if selectColumn.strip() == '':
                      # Set variable
                      selectColumn = 'select actionnumberreturn as "Action Number"'
    ...
    # Catch exceptions
      ...
      # Set message
      returnMessage = [{'SError': 'Error', 'SMessage': 'Caught ' + actionWord + ' control media feed execution failure'}]

      # Log message
      self._setLogger('Issue ' + actionWord + ' control media feed : ' + str(e))
  ...
  # Insert, Update, or Delete control media feed
  def _insertupdatedeleteControlMediaFeed(self, type, actionWord, procedure, optionMode, possibleParams, feedStorage, removeParams):
            ...
            if payloadNew:
              ...
              if payloadNew != None:
                ...
                if payloadStorage:
                  ...
                  # Store Message
                  returnDict = {"Status": "Error", "Message": "Process halted, mandatory parameter(s) was/were not provided", "Result": []}
              else:
                # Store Message
  ...
  def __openConnection(self, type = 'notype'):
    ...
    try:
      ...
      cmfwsconfig = controlmediafeedwebserviceconfig.ControlMediaFeedWebServiceConfig()

      # Set variables based on type
      cmfwsconfig._setConfigVars(type)

      # Create empty dictionary
      conVars = {}

      # Get dictionary of values
      conVars = cmfwsconfig._getConfigVars()
  ...
  def _setLogDictConfig(self):
    ...
    # Set variable
    feedType = 'controlmedia'

    # create object of control media feed parser config
    cmfwsconfig = controlmediafeedwebserviceconfig.ControlMediaFeedWebServiceConfig()

    # Set variables based on type
    cmfwsconfig._setFilenameVars('Log')

    # Get dictionary of values
    dictFeedType = cmfwsconfig._getFilenameVars()
    ...
    returnDict['created'] = '11/18/2020'
    returnDict['updated'] = '11/18/2020'
    ...
    returnDict['loggers'][feedType + 'feedwebserviceinfo'] = {}
    returnDict['loggers'][feedType + 'feedwebserviceinfo']['level'] = 'ERROR'
    returnDict['loggers'][feedType + 'feedwebserviceinfo']['handlers'] = ["error_file_handler"]
    returnDict['loggers'][feedType + 'feedwebserviceinfo']['propagate'] = False
